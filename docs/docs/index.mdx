...
Every block factory follows the same `<kind>Block` naming pattern: [`actionsBlock`](reference/typescript/functions/actionsBlock), [`contextBlock`](reference/typescript/functions/contextBlock), [`dividerBlock`](reference/typescript/functions/dividerBlock), [`fileBlock`](reference/typescript/functions/fileBlock), [`headerBlock`](reference/typescript/functions/headerBlock), [`imageBlock`](reference/typescript/functions/imageBlock), [`inputBlock`](reference/typescript/functions/inputBlock), [`markdownBlock`](reference/typescript/functions/markdownBlock), [`richTextBlock`](reference/typescript/functions/richTextBlock), [`sectionBlock`](reference/typescript/functions/sectionBlock), [`tableBlock`](reference/typescript/functions/tableBlock), and [`videoBlock`](reference/typescript/functions/videoBlock).
