...
Run it with `node hello.mjs`. Pin the current major release with `slackblocks@^2.0.0`, and uninstall with `pnpm remove slackblocks` (or your package manager's equivalent).
