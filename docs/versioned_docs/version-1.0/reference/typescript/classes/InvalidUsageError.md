...
Defined in: typescript/src/errors.ts:9
...
- [`MutualExclusivityError`](MutualExclusivityError.md)
- [`TypeMismatchError`](TypeMismatchError.md)
- [`MissingRequiredError`](MissingRequiredError.md)
...
> `readonly` **category**: [`ErrorCategory`](../type-aliases/ErrorCategory.md) = `"invalid-usage"`

Defined in: typescript/src/errors.ts:10
