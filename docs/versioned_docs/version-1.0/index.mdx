...
Factories such as [`plainText`](/1.0.0/reference/typescript/functions/plainText), [`mrkdwn`](/1.0.0/reference/typescript/functions/mrkdwn), and [`option`](/1.0.0/reference/typescript/functions/option) create the small values used throughout Block Kit payloads.

### Elements

Interactive controls are built with factories such as [`button`](/1.0.0/reference/typescript/functions/button), [`checkboxes`](/1.0.0/reference/typescript/functions/checkboxes), [`staticSelect`](/1.0.0/reference/typescript/functions/staticSelect), and [`datePicker`](/1.0.0/reference/typescript/functions/datePicker).

### Blocks

Block factories include [`section`](/1.0.0/reference/typescript/functions/section), [`header`](/1.0.0/reference/typescript/functions/header), [`divider`](/1.0.0/reference/typescript/functions/divider), [`actions`](/1.0.0/reference/typescript/functions/actions), [`richTextBlock`](/1.0.0/reference/typescript/functions/richTextBlock), [`markdownBlock`](/1.0.0/reference/typescript/functions/markdownBlock), and [`table`](/1.0.0/reference/typescript/functions/table).

### Messages and views

Use [`message`](/1.0.0/reference/typescript/functions/message), [`webhookMessage`](/1.0.0/reference/typescript/functions/webhookMessage), and [`messageResponse`](/1.0.0/reference/typescript/functions/messageResponse) for message payloads. Use [`modal`](/1.0.0/reference/typescript/functions/modal) and [`homeTab`](/1.0.0/reference/typescript/functions/homeTab) for Slack views.

### Utilities

- [`blockKitBuilderUrl`](/1.0.0/reference/typescript/functions/blockKitBuilderUrl) creates a browser preview URL.
- [`validate`](/1.0.0/reference/typescript/functions/validate) and [`assertValid`](/1.0.0/reference/typescript/functions/assertValid) validate existing Slack-shaped data.
