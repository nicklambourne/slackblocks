...
public final class ContextBlock implements Block {
  /** Immutable builder snapshot. */
  private final Map<String, Object> values;

  /** Stores one validated builder snapshot. */
  private ContextBlock(Map<String, Object> values) {
    this.values = values;
  }
  ...
  public boolean equals(Object other) {
    return this == other || (other instanceof ContextBlock that && toMap().equals(that.toMap()));
  }
  ...
  /** Concrete fluent builder for {@link ContextBlock}. */
  public static final class Builder implements Buildable<ContextBlock> {
    /** Mutable state isolated to this builder. */
    private final BuilderState state = new BuilderState("ContextBlock", "context");
    ...
    public ContextBlock build() {
      return state.build(ContextBlock::new);
    }
  }
}
