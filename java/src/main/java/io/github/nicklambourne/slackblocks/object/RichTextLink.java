...
public final class RichTextLink implements SlackObject {
  ...
  public boolean equals(Object other) {
    return this == other || (other instanceof RichTextLink that && toMap().equals(that.toMap()));
  }
  ...
  /** Concrete fluent builder for {@link RichTextLink}. */
