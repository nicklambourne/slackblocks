...
/**
 * Creates a workspace-user multi-select.
 *
 * @see <a href="https://docs.slack.dev/reference/block-kit">Slack Block Kit reference</a>
 */
@JsonAdapter(SlackObjectJsonAdapter.class)
public final class UserMultiSelectElement extends BlockElement implements Element {
  /** Immutable builder snapshot. */
  private final Map<String, Object> values;

  /** Stores one validated builder snapshot. */
  private UserMultiSelectElement(Map<String, Object> values) {
    this.values = values;
  }
  ...
  public boolean equals(Object other) {
    return this == other || (other instanceof UserMultiSelectElement that && toMap().equals(that.toMap()));
  }
  ...
  /** Concrete fluent builder for {@link UserMultiSelectElement}. */
  public static final class Builder implements Buildable<UserMultiSelectElement> {
    /** Mutable state isolated to this builder. */
    private final BuilderState state = new BuilderState("UserMultiSelect", "multi_users_select");
    ...
    /**
     * Adds values to Slack's {@code initial_users} field in order.
     *
     * @param values values to append
     * @return this builder
     */
    public Builder initialUsers(String... values) {
      state.append("initial_users", (Object[]) Objects.requireNonNull(values, "initialUsers"));
      return this;
    }
    ...
    public UserMultiSelectElement build() {
      return state.build(UserMultiSelectElement::new);
    }
  }
}
