 ...
 *
 * @see <a
 *     href="https://docs.slack.dev/reference/block-kit/block-elements/date-picker-element">Slack
 *     reference</a>
 */
...
public final class DatePickerElement extends BlockElement implements InputElement {
  ...
  public boolean equals(Object other) {
    return this == other || (other instanceof DatePickerElement that && values.equals(that.values));
  }
  ...
  /** Fluent builder for {@link DatePickerElement}. Builders are mutable and not thread-safe. */
  public static final class Builder implements Buildable<DatePickerElement> {
    private final BuilderState state = new BuilderState("DatePickerElement", "datepicker");
     ...
     *
     * @return an immutable {@link DatePickerElement}
