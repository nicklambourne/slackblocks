...
public final class RawText implements TableCell, DataTableCell {
  ...
  public boolean equals(Object other) {
    return this == other || (other instanceof RawText that && values.equals(that.values));
  }
  ...
  /** Fluent builder for {@link RawText}. Builders are mutable and not thread-safe. */
  public static final class Builder implements Buildable<RawText> {
     ...
     *
     * @return an immutable {@link RawText}
