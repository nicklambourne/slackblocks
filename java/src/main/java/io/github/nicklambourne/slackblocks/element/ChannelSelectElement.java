...
/**
 * Creates a public-channel single-select.
 *
 * @see <a href="https://docs.slack.dev/reference/block-kit">Slack Block Kit reference</a>
 */
@JsonAdapter(SlackObjectJsonAdapter.class)
public final class ChannelSelectElement extends BlockElement implements Element {
  /** Immutable builder snapshot. */
  private final Map<String, Object> values;

  /** Stores one validated builder snapshot. */
  private ChannelSelectElement(Map<String, Object> values) {
    this.values = values;
  }
  ...
  public boolean equals(Object other) {
    return this == other || (other instanceof ChannelSelectElement that && toMap().equals(that.toMap()));
  }
  ...
  /** Concrete fluent builder for {@link ChannelSelectElement}. */
  public static final class Builder implements Buildable<ChannelSelectElement> {
    /** Mutable state isolated to this builder. */
    private final BuilderState state = new BuilderState("ChannelSelect", "channels_select");
    ...
    public Builder initialChannel(String value) {
      state.set("initial_channel", Objects.requireNonNull(value, "initialChannel"));
      return this;
    }
