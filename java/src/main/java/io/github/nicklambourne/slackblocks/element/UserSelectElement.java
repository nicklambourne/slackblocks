...
/**
 * Creates a workspace-user single-select.
 *
 * @see <a href="https://docs.slack.dev/reference/block-kit">Slack Block Kit reference</a>
 */
@JsonAdapter(SlackObjectJsonAdapter.class)
public final class UserSelectElement extends BlockElement implements Element {
  /** Immutable builder snapshot. */
  private final Map<String, Object> values;

  /** Stores one validated builder snapshot. */
  private UserSelectElement(Map<String, Object> values) {
    this.values = values;
  }
  ...
  public boolean equals(Object other) {
    return this == other || (other instanceof UserSelectElement that && toMap().equals(that.toMap()));
  }
  ...
  /** Concrete fluent builder for {@link UserSelectElement}. */
  public static final class Builder implements Buildable<UserSelectElement> {
    /** Mutable state isolated to this builder. */
    private final BuilderState state = new BuilderState("UserSelect", "users_select");
    ...
    public Builder initialUser(String value) {
      state.set("initial_user", Objects.requireNonNull(value, "initialUser"));
      return this;
    }
