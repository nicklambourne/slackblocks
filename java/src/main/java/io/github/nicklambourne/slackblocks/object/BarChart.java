...
public final class BarChart implements SlackObject {
  ...
  public boolean equals(Object other) {
    return this == other || (other instanceof BarChart that && toMap().equals(that.toMap()));
  }
  ...
  /** Concrete fluent builder for {@link BarChart}. */
