...
/**
 * Creates a conversation single-select.
 *
 * @see <a href="https://docs.slack.dev/reference/block-kit">Slack Block Kit reference</a>
 */
@JsonAdapter(SlackObjectJsonAdapter.class)
public final class ConversationSelectElement extends BlockElement implements Element {
  ...
  public boolean equals(Object other) {
    return this == other || (other instanceof ConversationSelectElement that && toMap().equals(that.toMap()));
  }
  ...
  /** Concrete fluent builder for {@link ConversationSelectElement}. */
  public static final class Builder implements Buildable<ConversationSelectElement> {
    /** Mutable state isolated to this builder. */
    private final BuilderState state = new BuilderState("ConversationSelect", "conversations_select");
    ...
    /**
     * Sets whether response url enabled is enabled.
     *
