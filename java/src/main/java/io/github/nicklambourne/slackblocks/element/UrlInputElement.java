...
public final class UrlInputElement extends BlockElement implements Element {
  ...
  public boolean equals(Object other) {
    return this == other || (other instanceof UrlInputElement that && toMap().equals(that.toMap()));
  }
  ...
  /** Concrete fluent builder for {@link UrlInputElement}. */
  public static final class Builder implements Buildable<UrlInputElement> {
    /** Mutable state isolated to this builder. */
    private final BuilderState state = new BuilderState("URLInput", "url_text_input");
