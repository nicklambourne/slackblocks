...
/**
 * Creates a WYSIWYG rich-text editor.
 *
 * @see <a href="https://docs.slack.dev/reference/block-kit">Slack Block Kit reference</a>
 */
@JsonAdapter(SlackObjectJsonAdapter.class)
public final class RichTextInputElement extends BlockElement implements Element {
  /** Immutable builder snapshot. */
  private final Map<String, Object> values;

  /** Stores one validated builder snapshot. */
  private RichTextInputElement(Map<String, Object> values) {
    this.values = values;
  }
  ...
  public boolean equals(Object other) {
    return this == other || (other instanceof RichTextInputElement that && toMap().equals(that.toMap()));
  }
  ...
  /** Concrete fluent builder for {@link RichTextInputElement}. */
  public static final class Builder implements Buildable<RichTextInputElement> {
    /** Mutable state isolated to this builder. */
    private final BuilderState state = new BuilderState("RichTextInput", "rich_text_input");
     ...
     * @return this builder
     */
    public Builder minLines(int value) {
      state.set("min_lines", value);
      return this;
    }
    ...
    public RichTextInputElement build() {
      return state.build(RichTextInputElement::new);
    }
  }
}
