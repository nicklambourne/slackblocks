...
public final class TimePickerElement extends BlockElement implements Element {
  ...
  public boolean equals(Object other) {
    return this == other || (other instanceof TimePickerElement that && toMap().equals(that.toMap()));
  }
  ...
  /** Concrete fluent builder for {@link TimePickerElement}. */
  public static final class Builder implements Buildable<TimePickerElement> {
    /** Mutable state isolated to this builder. */
    private final BuilderState state = new BuilderState("TimePicker", "timepicker");
     ...
     * Sets initial time.
     *
     * @param value value for Slack's {@code initial_time} field
     * @return this builder
     */
    public Builder initialTime(String value) {
      state.set("initial_time", Objects.requireNonNull(value, "initialTime"));
      return this;
    }
     ...
     * Sets timezone.
     *
     * @param value value for Slack's {@code timezone} field
     * @return this builder
     */
    public Builder timezone(String value) {
      state.set("timezone", Objects.requireNonNull(value, "timezone"));
      return this;
    }
    ...
    public TimePickerElement build() {
      return state.build(TimePickerElement::new);
    }
  }
}
