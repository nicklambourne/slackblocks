 ...
 *
 * @see <a
 *     href="https://docs.slack.dev/reference/block-kit/block-elements/time-picker-element">Slack
 *     reference</a>
 */
@JsonAdapter(SlackObjectJsonAdapter.class)
public final class TimePickerElement extends BlockElement implements InputElement {
  private final Map<String, Object> values;
  private final Map<String, Object> fields;
  private final int hash;

  private TimePickerElement(Map<String, Object> values, Map<String, Object> fields) {
    this.values = values;
    this.fields = fields;
  ...
  public String getActionId() {
    return TypedFields.required(fields, "TimePickerElement", "action_id", String.class);
  }
  ...
  public Optional<String> getInitialTime() {
    return TypedFields.optional(fields, "TimePickerElement", "initial_time", String.class);
  }
  ...
  public Optional<String> getTimezone() {
    return TypedFields.optional(fields, "TimePickerElement", "timezone", String.class);
  }
  ...
  public Optional<Confirmation> getConfirm() {
    return TypedFields.optional(fields, "TimePickerElement", "confirm", Confirmation.class);
  }
  ...
  public Optional<Boolean> getFocusOnLoad() {
    return TypedFields.optional(fields, "TimePickerElement", "focus_on_load", Boolean.class);
  }
  ...
  public Optional<PlainText> getPlaceholder() {
    return TypedFields.optionalText(fields, "TimePickerElement", "placeholder", PlainText.class);
  }
  ...
  public boolean equals(Object other) {
    return this == other || (other instanceof TimePickerElement that && values.equals(that.values));
  }
  ...
  /** Fluent builder for {@link TimePickerElement}. Builders are mutable and not thread-safe. */
  public static final class Builder implements Buildable<TimePickerElement> {
    private final BuilderState state = new BuilderState("TimePickerElement", "timepicker");
     ...
     *
     * @return an immutable {@link TimePickerElement}
