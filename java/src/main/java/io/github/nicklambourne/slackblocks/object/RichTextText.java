...
public final class RichTextText implements SlackObject {
  ...
  public boolean equals(Object other) {
    return this == other || (other instanceof RichTextText that && toMap().equals(that.toMap()));
  }
  ...
  /** Concrete fluent builder for {@link RichTextText}. */
  public static final class Builder implements Buildable<RichTextText> {
    /** Mutable state isolated to this builder. */
    private final BuilderState state = new BuilderState("RichText", "text");
