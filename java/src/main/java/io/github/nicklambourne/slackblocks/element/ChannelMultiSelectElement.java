...
public final class ChannelMultiSelectElement extends BlockElement implements InputElement {
  private final Map<String, Object> values;
  private final Map<String, Object> fields;
  private final int hash;

  private ChannelMultiSelectElement(Map<String, Object> values, Map<String, Object> fields) {
    this.values = values;
    this.fields = fields;
  ...
  public String getActionId() {
    return TypedFields.required(fields, "ChannelMultiSelectElement", "action_id", String.class);
  }
  ...
  public List<String> getInitialChannels() {
    return TypedFields.list(fields, "ChannelMultiSelectElement", "initial_channels", String.class);
  }
  ...
  public Optional<Confirmation> getConfirm() {
    return TypedFields.optional(fields, "ChannelMultiSelectElement", "confirm", Confirmation.class);
  }
  ...
  public OptionalInt getMaxSelectedItems() {
    return TypedFields.optionalInt(fields, "ChannelMultiSelectElement", "max_selected_items");
  }
  ...
  public Optional<Boolean> getFocusOnLoad() {
    return TypedFields.optional(
        fields, "ChannelMultiSelectElement", "focus_on_load", Boolean.class);
  }
  ...
  public Optional<PlainText> getPlaceholder() {
    return TypedFields.optionalText(
        fields, "ChannelMultiSelectElement", "placeholder", PlainText.class);
  }
  ...
  public boolean equals(Object other) {
    return this == other
        || (other instanceof ChannelMultiSelectElement that && values.equals(that.values));
  }
  ...
  /**
   * Fluent builder for {@link ChannelMultiSelectElement}. Builders are mutable and not thread-safe.
   */
  public static final class Builder implements Buildable<ChannelMultiSelectElement> {
    private final BuilderState state =
        new BuilderState("ChannelMultiSelectElement", "multi_channels_select");
    ...
    public Builder initialChannels(String... values) {
      state.append("initial_channels", (Object[]) values);
      return this;
    }
     ...
     *
     * @return an immutable {@link ChannelMultiSelectElement}
