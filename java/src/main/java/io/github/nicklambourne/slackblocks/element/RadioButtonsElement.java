...
public final class RadioButtonsElement extends BlockElement implements Element {
  ...
  public boolean equals(Object other) {
    return this == other || (other instanceof RadioButtonsElement that && toMap().equals(that.toMap()));
  }
  ...
  /** Concrete fluent builder for {@link RadioButtonsElement}. */
  public static final class Builder implements Buildable<RadioButtonsElement> {
    /** Mutable state isolated to this builder. */
    private final BuilderState state = new BuilderState("RadioButtons", "radio_buttons");
