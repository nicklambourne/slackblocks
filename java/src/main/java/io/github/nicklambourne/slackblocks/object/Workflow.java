...
/**
 * Creates a workflow composition object.
 *
...
public final class Workflow implements SlackObject {
  ...
  public boolean equals(Object other) {
    return this == other || (other instanceof Workflow that && toMap().equals(that.toMap()));
  }
  ...
  /** Concrete fluent builder for {@link Workflow}. */
  public static final class Builder implements Buildable<Workflow> {
    ...
    /**
     * Sets trigger from a string.
     *
     * @param value value for Slack's {@code trigger} field
     * @return this builder
     */
    public Builder trigger(String value) {
      state.set("trigger", Objects.requireNonNull(value, "trigger"));
      return this;
    }

    /**
     * Sets Slack's {@code trigger} field from a typed Slack value.
     *
     * @param value nested Slack value
     * @return this builder
     */
    public Builder trigger(SlackObject value) {
      state.set("trigger", Objects.requireNonNull(value, "trigger"));
      return this;
    }
    /**
