...
/**
 * Creates a free-form text input.
 *
 * @see <a href="https://docs.slack.dev/reference/block-kit">Slack Block Kit reference</a>
 */
@JsonAdapter(SlackObjectJsonAdapter.class)
public final class PlainTextInputElement extends BlockElement implements Element {
  /** Immutable builder snapshot. */
  private final Map<String, Object> values;

  /** Stores one validated builder snapshot. */
  private PlainTextInputElement(Map<String, Object> values) {
    this.values = values;
  }
  ...
  public boolean equals(Object other) {
    return this == other || (other instanceof PlainTextInputElement that && toMap().equals(that.toMap()));
  }
  ...
  /** Concrete fluent builder for {@link PlainTextInputElement}. */
  public static final class Builder implements Buildable<PlainTextInputElement> {
    /** Mutable state isolated to this builder. */
    private final BuilderState state = new BuilderState("PlainTextInput", "plain_text_input");
    ...
    /**
     * Sets whether multiline is enabled.
     *
