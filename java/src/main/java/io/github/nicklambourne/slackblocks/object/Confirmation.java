...
/**
 * Creates a confirmation-dialog composition object.
 *
...
public final class Confirmation implements SlackObject {
  ...
  public boolean equals(Object other) {
    return this == other || (other instanceof Confirmation that && toMap().equals(that.toMap()));
  }
  ...
  /** Concrete fluent builder for {@link Confirmation}. */
  public static final class Builder implements Buildable<Confirmation> {
    ...
    public Builder confirm(String value) {
      state.set("confirm", WireObjects.text("plain_text", Objects.requireNonNull(value, "confirm")));
      return this;
    }
    ...
    /**
     * Sets deny from a string.
     *
     * @param value value for Slack's {@code deny} field
     * @return this builder
     */
    ...
    /**
     * Sets Slack's {@code deny} field from a typed Slack value.
     *
     * @param value nested Slack value
     * @return this builder
     */
    public Builder deny(SlackObject value) {
      state.set("deny", Objects.requireNonNull(value, "deny"));
      return this;
    }
