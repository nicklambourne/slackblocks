...
public final class RichTextUserGroup implements SlackObject {
  /** Immutable builder snapshot. */
  private final Map<String, Object> values;

  /** Stores one validated builder snapshot. */
  private RichTextUserGroup(Map<String, Object> values) {
    this.values = values;
  }
  ...
  public boolean equals(Object other) {
    return this == other || (other instanceof RichTextUserGroup that && toMap().equals(that.toMap()));
  }
  ...
  /** Concrete fluent builder for {@link RichTextUserGroup}. */
  public static final class Builder implements Buildable<RichTextUserGroup> {
    /** Mutable state isolated to this builder. */
    private final BuilderState state = new BuilderState("RichTextUserGroup", "usergroup");
     ...
     * Sets usergroup id.
     *
     * @param value value for Slack's {@code usergroup_id} field
     * @return this builder
     */
    public Builder userGroupId(String value) {
      state.set("usergroup_id", Objects.requireNonNull(value, "userGroupId"));
      return this;
    }
    ...
    public RichTextUserGroup build() {
      return state.build(RichTextUserGroup::new);
    }
  }
}
