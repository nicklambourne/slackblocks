...
public final class FileInputElement extends BlockElement implements Element {
  ...
  public boolean equals(Object other) {
    return this == other || (other instanceof FileInputElement that && toMap().equals(that.toMap()));
  }
  ...
  /** Concrete fluent builder for {@link FileInputElement}. */
  public static final class Builder implements Buildable<FileInputElement> {
    /** Mutable state isolated to this builder. */
    private final BuilderState state = new BuilderState("FileInput", "file_input");
    ...
    /**
     * Adds values to Slack's {@code filetypes} field in order.
     *
     * @param values values to append
     * @return this builder
     */
    public Builder filetypes(String... values) {
      state.append("filetypes", (Object[]) Objects.requireNonNull(values, "filetypes"));
      return this;
    }
