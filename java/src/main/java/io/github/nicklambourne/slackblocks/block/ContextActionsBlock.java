 ...
 * </ul>
 *
 * @see <a href="https://docs.slack.dev/reference/block-kit/blocks/context-actions-block">Slack
 *     reference</a>
 */
...
public final class ContextActionsBlock implements Block {
  ...
  private ContextActionsBlock(Map<String, Object> values, Map<String, Object> fields) {
    this.values = values;
    this.fields = fields;
  ...
  public List<ContextActionsElement> getElements() {
    return TypedFields.list(fields, "ContextActionsBlock", "elements", ContextActionsElement.class);
  }
  ...
  public boolean equals(Object other) {
    return this == other
        || (other instanceof ContextActionsBlock that && values.equals(that.values));
  }
  ...
  /** Fluent builder for {@link ContextActionsBlock}. Builders are mutable and not thread-safe. */
  public static final class Builder implements Buildable<ContextActionsBlock> {
     ...
     *
     * <p>Required. Slack allows at most 5 items. Each call appends to any values already added.
     *
     * @param values {@link ContextActionsElement} values appended in order
     * @return this builder
     */
    public Builder elements(ContextActionsElement... values) {
     ...
     *
     * @return an immutable {@link ContextActionsBlock}
