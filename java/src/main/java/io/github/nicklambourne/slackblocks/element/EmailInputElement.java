...
public final class EmailInputElement extends BlockElement implements Element {
  /** Immutable builder snapshot. */
  private final Map<String, Object> values;

  /** Stores one validated builder snapshot. */
  private EmailInputElement(Map<String, Object> values) {
    this.values = values;
  }
  ...
  public boolean equals(Object other) {
    return this == other || (other instanceof EmailInputElement that && toMap().equals(that.toMap()));
  }
  ...
  /** Concrete fluent builder for {@link EmailInputElement}. */
  public static final class Builder implements Buildable<EmailInputElement> {
    /** Mutable state isolated to this builder. */
    private final BuilderState state = new BuilderState("EmailInput", "email_text_input");
    ...
    public EmailInputElement build() {
      return state.build(EmailInputElement::new);
    }
  }
}
