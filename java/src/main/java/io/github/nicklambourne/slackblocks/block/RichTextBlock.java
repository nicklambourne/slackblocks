...
public final class RichTextBlock implements Block {
  ...
  public boolean equals(Object other) {
    return this == other || (other instanceof RichTextBlock that && toMap().equals(that.toMap()));
  }
  ...
  /** Concrete fluent builder for {@link RichTextBlock}. */
