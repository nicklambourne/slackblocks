 ...
 *
 * @see <a
 *     href="https://docs.slack.dev/reference/block-kit/block-elements/datetime-picker-element">Slack
 *     reference</a>
 */
...
public final class DateTimePickerElement extends BlockElement implements InputElement {
  ...
  public boolean equals(Object other) {
    return this == other
        || (other instanceof DateTimePickerElement that && values.equals(that.values));
  }
  ...
  /** Fluent builder for {@link DateTimePickerElement}. Builders are mutable and not thread-safe. */
  public static final class Builder implements Buildable<DateTimePickerElement> {
    private final BuilderState state = new BuilderState("DateTimePickerElement", "datetimepicker");
     ...
     *
     * @return an immutable {@link DateTimePickerElement}
