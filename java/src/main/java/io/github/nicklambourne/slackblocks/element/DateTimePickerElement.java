...
/**
 * Creates a combined date-and-time picker.
 *
 * @see <a href="https://docs.slack.dev/reference/block-kit">Slack Block Kit reference</a>
 */
@JsonAdapter(SlackObjectJsonAdapter.class)
public final class DateTimePickerElement extends BlockElement implements Element {
  ...
  public boolean equals(Object other) {
    return this == other || (other instanceof DateTimePickerElement that && toMap().equals(that.toMap()));
  }
  ...
  /** Concrete fluent builder for {@link DateTimePickerElement}. */
  public static final class Builder implements Buildable<DateTimePickerElement> {
    /** Mutable state isolated to this builder. */
    private final BuilderState state = new BuilderState("DateTimePicker", "datetimepicker");
    ...
    /**
     * Sets initial date time.
     *
     * @param value value for Slack's {@code initial_date_time} field
     * @return this builder
     */
    public Builder initialDateTime(long value) {
      state.set("initial_date_time", value);
      return this;
    }
    ...
    public DateTimePickerElement build() {
      return state.build(DateTimePickerElement::new);
    }
  }
}
