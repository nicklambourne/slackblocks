...
/**
 * Creates an externally populated single-select.
 *
 * @see <a href="https://docs.slack.dev/reference/block-kit">Slack Block Kit reference</a>
 */
@JsonAdapter(SlackObjectJsonAdapter.class)
public final class ExternalSelectElement extends BlockElement implements Element {
  ...
  public boolean equals(Object other) {
    return this == other || (other instanceof ExternalSelectElement that && toMap().equals(that.toMap()));
  }
  ...
  /** Concrete fluent builder for {@link ExternalSelectElement}. */
  public static final class Builder implements Buildable<ExternalSelectElement> {
    /** Mutable state isolated to this builder. */
    private final BuilderState state = new BuilderState("ExternalSelect", "external_select");
