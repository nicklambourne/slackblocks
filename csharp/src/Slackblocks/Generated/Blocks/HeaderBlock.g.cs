...
/// <summary>Large, bold plain text that introduces a group of blocks.</summary>
/// <remarks>
/// <list type="bullet">
/// <item><description>Required: <c>text</c>.</description></item>
/// </list>
/// <para>See the <see href="https://docs.slack.dev/reference/block-kit/blocks/header-block">Slack reference</see>.</para>
/// </remarks>
[global::System.Text.Json.Serialization.JsonConverter(typeof(global::Slackblocks.Internal.SlackObjectJsonConverterFactory))]
public sealed partial class HeaderBlock : global::Slackblocks.SlackObject, global::Slackblocks.Blocks.IBlock
{
    /// <summary>Creates and validates a <see cref="HeaderBlock"/>.</summary>
    /// <param name="text">The header text, shown in a larger bold font. Required. Slack allows at most 150 characters. A string is sent as a <c>plain_text</c> text object.</param>
    ...
    {
        var wire = new global::Slackblocks.Internal.WireBuilder("HeaderBlock", "header");
        Text = wire.Text("text", text, "plain_text")!;
        BlockId = wire.String("block_id", blockId);
        Initialize(wire.Build(additionalFields));
    }

    /// <summary>Gets the header text, shown in a larger bold font.</summary>
