...
/// <summary>A row of feedback or icon buttons, usually shown below AI-generated content.</summary>
/// <remarks>
/// <list type="bullet">
/// <item><description>Required: <c>elements</c>.</description></item>
/// </list>
/// <para>See the <see href="https://docs.slack.dev/reference/block-kit/blocks/context-actions-block">Slack reference</see>.</para>
/// </remarks>
[global::System.Text.Json.Serialization.JsonConverter(typeof(global::Slackblocks.Internal.SlackObjectJsonConverterFactory))]
public sealed partial class ContextActionsBlock : global::Slackblocks.SlackObject, global::Slackblocks.Blocks.IBlock
{
    /// <summary>Creates and validates a <see cref="ContextActionsBlock"/>.</summary>
    /// <param name="elements">Feedback buttons or icon buttons in display order. Required. Slack allows at most 5 items.</param>
    ...
    public ContextActionsBlock(
        global::System.Collections.Generic.IEnumerable<global::Slackblocks.Blocks.IContextActionsElement> elements,
        string? blockId = null,
        global::System.Collections.Generic.IReadOnlyDictionary<string, object?>? additionalFields = null)
    {
        var wire = new global::Slackblocks.Internal.WireBuilder("ContextActionsBlock", "context_actions");
        Elements = wire.List("elements", elements);
        BlockId = wire.String("block_id", blockId);
        Initialize(wire.Build(additionalFields));
    }

    /// <summary>Gets feedback buttons or icon buttons in display order.</summary>
    /// <value>The values in order, or an empty list when none were set.</value>
    public global::System.Collections.Generic.IReadOnlyList<global::Slackblocks.Blocks.IContextActionsElement> Elements { get; }
