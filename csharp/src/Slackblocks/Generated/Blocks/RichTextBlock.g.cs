...
/// <summary>Formatted text built from sections, lists, preformatted blocks, and quotes.</summary>
/// <remarks>
/// <list type="bullet">
...
public sealed partial class RichTextBlock : global::Slackblocks.SlackObject, global::Slackblocks.Blocks.IBlock, global::Slackblocks.Blocks.ITableCell, global::Slackblocks.Blocks.IDataTableCell
{
    /// <summary>Creates and validates a <see cref="RichTextBlock"/>.</summary>
    /// <param name="elements">Sections, lists, preformatted blocks, and quotes in display order. Required.</param>
    ...
    public RichTextBlock(
        global::System.Collections.Generic.IEnumerable<global::Slackblocks.Objects.IRichTextBlockElement> elements,
        string? blockId = null,
        global::System.Collections.Generic.IReadOnlyDictionary<string, object?>? additionalFields = null)
    {
        var wire = new global::Slackblocks.Internal.WireBuilder("RichTextBlock", "rich_text");
        Elements = wire.List("elements", elements);
        BlockId = wire.String("block_id", blockId);
        Initialize(wire.Build(additionalFields));
    }

    /// <summary>Gets sections, lists, preformatted blocks, and quotes in display order.</summary>
    /// <value>The values in order, or an empty list when none were set.</value>
    public global::System.Collections.Generic.IReadOnlyList<global::Slackblocks.Objects.IRichTextBlockElement> Elements { get; }
