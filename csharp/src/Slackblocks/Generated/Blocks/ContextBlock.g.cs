...
/// <summary>A block of small, secondary images and text.</summary>
/// <remarks>
/// <list type="bullet">
/// <item><description>Required: <c>elements</c>.</description></item>
/// </list>
/// <para>See the <see href="https://docs.slack.dev/reference/block-kit/blocks/context-block">Slack reference</see>.</para>
/// </remarks>
[global::System.Text.Json.Serialization.JsonConverter(typeof(global::Slackblocks.Internal.SlackObjectJsonConverterFactory))]
public sealed partial class ContextBlock : global::Slackblocks.SlackObject, global::Slackblocks.Blocks.IBlock
{
    /// <summary>Creates and validates a <see cref="ContextBlock"/>.</summary>
    /// <param name="elements">Images and text in display order. Required. Slack allows at most 10 items.</param>
    ...
    public ContextBlock(
        global::System.Collections.Generic.IEnumerable<global::Slackblocks.Blocks.IContextElement> elements,
        string? blockId = null,
        global::System.Collections.Generic.IReadOnlyDictionary<string, object?>? additionalFields = null)
    {
        var wire = new global::Slackblocks.Internal.WireBuilder("ContextBlock", "context");
        Elements = wire.List("elements", elements);
        BlockId = wire.String("block_id", blockId);
        Initialize(wire.Build(additionalFields));
    }

    /// <summary>Gets images and text in display order.</summary>
    /// <value>The values in order, or an empty list when none were set.</value>
    public global::System.Collections.Generic.IReadOnlyList<global::Slackblocks.Blocks.IContextElement> Elements { get; }
