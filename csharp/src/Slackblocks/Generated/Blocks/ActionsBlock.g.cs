...
/// <summary>A block that holds interactive elements such as buttons and menus.</summary>
/// <remarks>
/// <list type="bullet">
/// <item><description>Required: <c>elements</c>.</description></item>
/// </list>
/// <para>See the <see href="https://docs.slack.dev/reference/block-kit/blocks/actions-block">Slack reference</see>.</para>
/// </remarks>
[global::System.Text.Json.Serialization.JsonConverter(typeof(global::Slackblocks.Internal.SlackObjectJsonConverterFactory))]
public sealed partial class ActionsBlock : global::Slackblocks.SlackObject, global::Slackblocks.Blocks.IBlock
{
    /// <summary>Creates and validates a <see cref="ActionsBlock"/>.</summary>
    /// <param name="elements">Interactive elements in display order. Required. Slack allows at most 25 items.</param>
    ...
    public ActionsBlock(
        global::System.Collections.Generic.IEnumerable<global::Slackblocks.Elements.IElement> elements,
        string? blockId = null,
        global::System.Collections.Generic.IReadOnlyDictionary<string, object?>? additionalFields = null)
    {
        var wire = new global::Slackblocks.Internal.WireBuilder("ActionsBlock", "actions");
        Elements = wire.List("elements", elements);
        BlockId = wire.String("block_id", blockId);
        Initialize(wire.Build(additionalFields));
    }

    /// <summary>Gets interactive elements in display order.</summary>
    /// <value>The values in order, or an empty list when none were set.</value>
    public global::System.Collections.Generic.IReadOnlyList<global::Slackblocks.Elements.IElement> Elements { get; }
