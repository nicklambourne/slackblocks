...
/// <summary>A user mention inside rich text.</summary>
/// <remarks>
/// <list type="bullet">
/// <item><description>Required: <c>userId</c>.</description></item>
/// </list>
...
public sealed partial class RichTextUser : global::Slackblocks.SlackObject, global::Slackblocks.Objects.IRichTextSectionElement
{
    /// <summary>Creates and validates a <see cref="RichTextUser"/>.</summary>
    /// <param name="userId">The ID of the mentioned user. Required.</param>
    ...
    {
        var wire = new global::Slackblocks.Internal.WireBuilder("RichTextUser", "user");
        UserId = wire.String("user_id", userId)!;
        Style = wire.Object("style", style);
        Initialize(wire.Build(additionalFields));
    }

    /// <summary>Gets the ID of the mentioned user.</summary>
