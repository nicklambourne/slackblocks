...
/// <summary>A plain-text composition object.</summary>
/// <remarks>
/// <list type="bullet">
...
public sealed partial class PlainText : global::Slackblocks.Objects.Text, global::Slackblocks.Blocks.IContextElement
{
    /// <summary>Creates and validates a <see cref="PlainText"/>.</summary>
    /// <param name="text">The text content. Required.</param>
    /// <param name="emoji">Whether emoji shortcodes such as :tada: are rendered as emoji.</param>
    ...
    {
        var wire = new global::Slackblocks.Internal.WireBuilder("PlainText", "plain_text");
        Text = wire.String("text", text)!;
        Emoji = wire.Boolean("emoji", emoji);
    ...
    /// <summary>Gets whether emoji shortcodes such as :tada: are rendered as emoji.</summary>
