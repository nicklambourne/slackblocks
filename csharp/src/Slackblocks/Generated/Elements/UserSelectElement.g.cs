...
/// <summary>A menu for selecting one workspace user.</summary>
/// <remarks>
/// <list type="bullet">
...
public sealed partial class UserSelectElement : global::Slackblocks.SlackObject, global::Slackblocks.Elements.IInputElement
{
    /// <summary>Creates and validates a <see cref="UserSelectElement"/>.</summary>
    ...
    /// <param name="initialUser">The user ID selected when the menu loads.</param>
    ...
    {
        var wire = new global::Slackblocks.Internal.WireBuilder("UserSelectElement", "users_select");
        ActionId = wire.String("action_id", actionId)!;
        InitialUser = wire.String("initial_user", initialUser);
    ...
    /// <summary>Gets the user ID selected when the menu loads.</summary>
