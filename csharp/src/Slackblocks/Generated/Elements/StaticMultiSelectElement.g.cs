...
/// <summary>A menu for selecting multiple options defined in the payload.</summary>
/// <remarks>
/// <list type="bullet">
...
public sealed partial class StaticMultiSelectElement : global::Slackblocks.SlackObject, global::Slackblocks.Elements.IInputElement
{
    /// <summary>Creates and validates a <see cref="StaticMultiSelectElement"/>.</summary>
    ...
    {
        var wire = new global::Slackblocks.Internal.WireBuilder("StaticMultiSelectElement", "multi_static_select");
    ...
    /// <summary>Gets labelled groups of options in display order. Cannot be combined with ungrouped options.</summary>
    /// <value>The values in order, or an empty list when none were set.</value>
    public global::System.Collections.Generic.IReadOnlyList<global::Slackblocks.Objects.OptionGroup> OptionGroups { get; }
