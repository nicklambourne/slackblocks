...
/// <summary>A compact menu of up to five options.</summary>
/// <remarks>
/// <list type="bullet">
/// <item><description>Required: <c>actionId</c>, <c>options</c>.</description></item>
/// </list>
/// <para>See the <see href="https://docs.slack.dev/reference/block-kit/block-elements/overflow-menu-element">Slack reference</see>.</para>
/// </remarks>
[global::System.Text.Json.Serialization.JsonConverter(typeof(global::Slackblocks.Internal.SlackObjectJsonConverterFactory))]
public sealed partial class OverflowElement : global::Slackblocks.SlackObject, global::Slackblocks.Elements.IElement
{
    /// <summary>Creates and validates a <see cref="OverflowElement"/>.</summary>
    ...
    /// <param name="options">Selectable options in display order. Required. Must contain between 1 and 5 items.</param>
    ...
    {
        var wire = new global::Slackblocks.Internal.WireBuilder("OverflowElement", "overflow");
