...
/// <summary>A single-line input that accepts an email address.</summary>
/// <remarks>
/// <list type="bullet">
/// <item><description>Required: <c>actionId</c>.</description></item>
/// </list>
/// <para>See the <see href="https://docs.slack.dev/reference/block-kit/block-elements/email-input-element">Slack reference</see>.</para>
/// </remarks>
[global::System.Text.Json.Serialization.JsonConverter(typeof(global::Slackblocks.Internal.SlackObjectJsonConverterFactory))]
public sealed partial class EmailInputElement : global::Slackblocks.SlackObject, global::Slackblocks.Elements.IInputElement
{
    /// <summary>Creates and validates a <see cref="EmailInputElement"/>.</summary>
    ...
    {
        var wire = new global::Slackblocks.Internal.WireBuilder("EmailInputElement", "email_text_input");
